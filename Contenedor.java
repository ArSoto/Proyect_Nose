...
////////////////////////////////////////////////////////////////////
    ...
    public  boolean setDespegarModoAvion() {

        condiciones_Despegar();

        if ((panel.getVelocidad() > 350) && (panel.getAltura() == 0) && (("Fighter".equals(panel.getEstado())) || ("Gerwalk".equals(panel.getEstado())))) {
    ...
    private void condiciones_Despegar() {
