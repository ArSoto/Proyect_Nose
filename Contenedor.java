...
/////////////////////////////////////////////////////////////////
    ...
    public boolean aterrizar() {
        ...
        while (true) {
            ...
            System.out.println("¿Desea aterrizar? s/n");
            boton = scanner.nextLine();
    ...
    public void movimientosAire() {
        ...
        if (panel.getAltura()<= min ) System.out.print(" (z) Crear pista.");
        if (panel.getPista()) System.out.print("(x) Aterrizar.");
        System.out.println();
        ...
        switch (boton) {
            ...
            case "s": {
                if (panel.getAltura() > min) {
                    panel.setAltura(panel.getAltura() - random.nextInt(100) + 10);

                    if (panel.getAltura() < min) {
                        panel.setAltura(min);
                        System.out.println("El avion alcanza la altura minima de vuelo: " + panel.getAltura() + " metros.");
                    }
           ...
           //-----> CAMBIAR DE FIGHTER O BATTLOID A GERWALK
            ...
            case "c": {if (b_der.getArma().size()>=1) disparar(b_der.getArma().get(0));break;

            }

            case "v":{if (b_der.getArma().size()>=2) disparar(b_der.getArma().get(1));break;

            }

            case "n":{if (b_izq.getArma().size()>=1) disparar(b_izq.getArma().get(0));break;

            }
            case "m":{if (b_izq.getArma().size()>=2) disparar(b_izq.getArma().get(1));break;
