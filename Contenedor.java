...
///////////////////////////////////////////////////////////////////
    ...
    public int iniciarPista() {
        ...
        do {
            ...
            if (eleccion == 1) {
                ...
                System.out.println("|||||No es posible iniciar  sin pista||||");
            }
        } while (eleccion != 1);
        return 1;
    }
    ...
    public int setDespegarModoAvion(int velocidad, int altura, int l_pista) {
        ...
        if ((panel.getVelocidad() > 350) && (altura == 0) && ((getCambiar() == 1) || (getCambiar() == 3))) {
            ...
            System.out.println("No cumple condiciones para iniciar vuelo en modo Fighter, presione 1.");
            Scanner scanner = new Scanner(System.in);
            int eleccion;
            eleccion = scanner.nextInt();
            return 1;
    ...
    public int movimientosSuelo() {
        ...
        switch (boton) {
            ...
            //--->PASAR DE BATTLOID O FIGHTER A GERWALK
